    ...
    class ComicQueryManager
    {
        ...
        private void UpdateAvailableQueries()
        {
            AvailableQueries = new ObservableCollection<ComicQuery> {
                new ComicQuery("LINQ makes queries easy", "A sample query",
                    ...
                    CreateImageFromAssets(@"F:\Programs\IT\Programming Language\C#\hfcs\chap14\LinqSplitApp\purple_250x250.jpg")),
                ...
                new ComicQuery("Expensive comics", "Comics over $500",
                    ...
                    CreateImageFromAssets(@"F:\Programs\IT\Programming Language\C#\hfcs\chap14\LinqSplitApp\captain_amazing_250x250.jpg")),
                ...
                new ComicQuery("LINQ is versatile 1", "Modify every item returned from the query",
                    ...
                    CreateImageFromAssets(@"F:\Programs\IT\Programming Language\C#\hfcs\chap14\LinqSplitApp\bluegray_250x250.jpg")),
                ...
                new ComicQuery("All comics in the collection",
                   ...
                   CreateImageFromAssets(@"F:\Programs\IT\Programming Language\C#\hfcs\chap14\LinqSplitApp\captain_amazing_zoom_250x250.jpg")),
            };
        }
        ...
        private void LinqIsVersatile3()
        {
            ...
            foreach (int n in shortList)
                CurrentQueryResults.Add(CreateAnonymousListViewItem(n.ToString(), @"F:\Programs\IT\Programming Language\C#\hfcs\chap14\LinqSplitApp\bluegray_250x250.jpg"));
        }

        private object CreateAnonymousListViewItem(string title,
                        string imageFilename = @"F:\Programs\IT\Programming Language\C#\hfcs\chap14\LinqSplitApp\purple_250x250.jpg")
        {
            return new
            {
                Title = title,
        ...
        private void CombineJimmysValuesIntoGroups()
        {
            ...
            foreach (var group in priceGroups)
            {
                ...
                CurrentQueryResults.Add(
                   CreateAnonymousListViewItem(message, @"F:\Programs\IT\Programming Language\C#\hfcs\chap14\LinqSplitApp\captain_amazing_250x250.jpg"));
            }
        }
